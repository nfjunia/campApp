                ...
                <div className="mb-6 mt-4 w-full lg:h-[8%]">
                  ...
                  {scanState === "success" ? (
                    <div className="text-center mt-4">
                      <h1 className="text-[17px] font-semibold text-neutral-700">
                      ...
                      <div className="flex pb-[230px] overflow-y-auto flex-col p-6 gap-4">
                        ...
                        >
                          ...
                          <h1
                            ...
                            className="cursor-pointer text-center mt-4 font-semibold"
                          >
                      ...
                      <div className="flex pb-[250px] overflow-y-auto flex-col p-6 gap-4">
                        ...
                        >
                          ...
                          <div className="flex mt-2 justify-center">
                            <button className="h-12 flex justify-center items-center w-full border border-neutral-600 rounded-xl">
                              <h1
                                onClick={() => setStep(1)}
